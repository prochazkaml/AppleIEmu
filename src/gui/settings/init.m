...
SettingsTabContainer.Padding = [0 0 0 0];

% Create TerminalAppearanceGridLayout
TerminalAppearanceGridLayout = uigridlayout(SettingsTabContainer);
TerminalAppearanceGridLayout.Layout.Row = 1;
TerminalAppearanceGridLayout.Layout.Column = 1;
